...
- 기체 수, 버전, 가동 상태 변경은 증거 사진 제보 후 관리자 승인을 거쳐 반영합니다.
...
주안 CPU 게임랜드는 인천권 주요 리듬게임 점포로 알파 2차 테스트 예정에 둡니다. 알파 1차 공개 운영과 검수 완료 조건에는 포함하지 않습니다.
...
- 알파 1차 점포 5곳은 모두 현장 조사 기준 기종 데이터를 반영했습니다.
- 주안 CPU 게임랜드는 정적 데이터에 알파 2차 예정 점포로 남기되 `PLANNED_ALPHA_2` 상태로 표시합니다.
...
1. 카카오 로그인, 단일 관리자 권한, 사진 개인정보 안내와 자동 삭제 정책을 기준으로 구현 계약을 고정합니다.
