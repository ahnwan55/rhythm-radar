...
- 알파 1차 점포 5곳 중 한성대 우리게임장2는 2026-05-27 현장 조사 기준 기종 데이터를 반영했고, 나머지 4곳은 `PENDING_VERIFICATION` 상태입니다.
...
- 상태: 문서화 중
- 기능 코드: 작성하지 않음
- 정적 데이터: 화면용 TypeScript 타입, 알파 1차 점포 5곳, 인천권 확장 후보 1곳, 한성대 우리게임장2 현장 조사 데이터 작성
